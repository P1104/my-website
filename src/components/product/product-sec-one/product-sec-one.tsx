...
export const ProductSecOne = () => {
  return (
    <div className="bg-white text-gray-900 relative overflow-hidden pt-12">
      {/* Sparkles Background */}
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex items-center justify-center gap-3 mb-8">
                <span className="text-2xl md:text-3xl text-gray-600">Power It with</span>
                <div className="flex items-center gap-2">
                  <Zap className="w-8 h-8 text-indigo-500" />
                  <span className="text-3xl md:text-4xl font-bold bg-clip-text text-black">
                    Equilibrate.AI
                  </span>
                </div>
              </div>
